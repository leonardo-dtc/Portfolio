...
(function () {
  ...
  var PALETTES = [
    { name: 'crimson', g: 'linear-gradient(180deg,#F7A8AF 0%,#E61E32 45%,#7A0E1C 100%)', ac: '#F2455A', hi: '#E61E32', deep: '#7C1E2A', lit: '#F7A8AF' },
    { name: 'coral',   g: 'linear-gradient(180deg,#EC9A9A 0%,#D06262 45%,#7E3A3A 100%)', ac: '#E18585', hi: '#E18585', deep: '#7E3A3A', lit: '#EC9A9A' },
    { name: 'silver',  g: 'linear-gradient(180deg,#E4E7EF 0%,#B2B7C6 45%,#6A6E7C 100%)', ac: '#D2D6E0', hi: '#D2D6E0', deep: '#6A6E7C', lit: '#E4E7EF' },
    { name: 'purple',  g: 'linear-gradient(180deg,#C9A8FF 0%,#9B6FE6 45%,#5E4694 100%)', ac: '#B585F2', hi: '#B585F2', deep: '#5E4694', lit: '#C9A8FF' },
    { name: 'blue',    g: 'linear-gradient(180deg,#A8C6F7 0%,#6E92DC 45%,#42588E 100%)', ac: '#8AAEE8', hi: '#8AAEE8', deep: '#42588E', lit: '#A8C6F7' },
  ...
  function inkFor(ac) { return lum(ac) > 0.35 ? '#07060A' : '#F5F3EE'; }
